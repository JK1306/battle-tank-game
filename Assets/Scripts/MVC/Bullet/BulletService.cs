...
public class BulletService : SingletonBehaviour<BulletService>
{
    ...
    public void fireBullet(BulletType bulletType, Transform firePosition){
        int i=0;
        ...
        bulletController = new BulletController(bulletScriptableObjectMaster.bulletView, bulletScriptableObjectMaster.bulletScriptableObjects[i], firePosition);
